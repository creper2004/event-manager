...
Проект Event Manager связан с другим микросервисом - Event Notificator с использованием **Kafka**. Ссылка на Event Notificator: https://github.com/creper2004/event-notificator

При изменении информации о мероприятии Event Manager оповещает Event Notificator о новый изменениях. В свою очередь Event Notificator создает уведомления для пользователей, которые зарегистрированы на измененное мероприятие. Пользователи получают "старую" и "новую" информацию о мероприятии в удобном режиме.
